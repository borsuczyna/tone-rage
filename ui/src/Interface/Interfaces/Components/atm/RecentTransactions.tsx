...
import { MoneyLogType, type MoneyLogEntityInterface } from '@shared/Models/MoneyLogData';
...
export default function RecentTransactions({ transactions, onViewAllClick }: RecentTransactionsProps) {
