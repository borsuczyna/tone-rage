...
export default function NavigatorSelector({ label, selectedValue, onValueChange, availableValues }) {
    ...
    return (<>
            ...
            <div className={styles.styleNavigator}>
                <button className={styles.styleArrow} onClick={goToPrevious} type="button">
                    &#8249;
                </button>
                <div className={styles.styleValue}>
                    {selectedValue + 1}
                </div>
                <button className={styles.styleArrow} onClick={goToNext} type="button">
                    &#8250;
                </button>
            </div>
        </>);
