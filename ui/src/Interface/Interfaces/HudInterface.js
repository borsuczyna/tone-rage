...
export default function HudInterface() {
    ...
    return (<div className={styles.main}>
            <div className={styles.playerInfo}>
                ...
                <div className={styles.avatarContainer}>
                    <svg className={styles.backgroundRing} viewBox="0 0 200 200">
                        ...
                        <circle className={styles.backgroundBar} cx="100" cy="100" r="75"/>
                        <circle className={styles.healthBar} cx="100" cy="100" r="75" style={{ strokeDashoffset: healthOffset }}/>
                        <circle className={styles.expBarGlow} cx="100" cy="100" r="75" style={{ strokeDashoffset: expOffset }}/>
                        <circle className={styles.expBar} cx="100" cy="100" r="75" style={{ strokeDashoffset: expOffset }}/>
                    </svg>
            ...
            {currentJob && (<div className={styles.jobInfo}>
