...
export default class VehicleInteractionWheel {
    ...
    private static toggleLocks(client: PlayerMp, open: boolean) {
        ...
        vehicle.locked = !open;
        NotificationService.addNotification(client, NotificationType.Info, translate('vehicle.doors.title'), open ? translate('vehicle.doors.unlocked') : translate('vehicle.doors.locked'), 'Lock');
    }
