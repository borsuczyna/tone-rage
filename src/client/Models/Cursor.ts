export const MAP_CURSOR_NAME_TO_TYPE = {
    CT_POINTER: 0,
    CT_CROSS: 1,
    CT_HAND: 2,
    CT_IBEAM: 3,
...
export const cursors = [
    {
        ...
        path: 'ui/cursors/pointer.png',
    },
    {
        type: MAP_CURSOR_NAME_TO_TYPE.CT_HELP,
        path: 'ui/cursors/help.png',
    },
    {
    ...
    },
    {
        ...
        path: 'ui/cursors/beam.png',
        offset: [-24, -24],
    },
    {
        type: MAP_CURSOR_NAME_TO_TYPE.CT_MOVE,
        path: 'ui/cursors/move.png',
        offset: [-18, -18],
    },
    {
        type: MAP_CURSOR_NAME_TO_TYPE.CT_EASTWESTRESIZE,
        path: 'ui/cursors/east-west-resize.png',
    },
    {
